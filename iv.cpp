...
int main() {
    ...
    auto stop_sequential = high_resolution_clock::now();
    auto duration_sequential = duration_cast<microseconds>(stop_sequential - start_sequential);

    // Output the execution time for the sequential version
    cout << "Sequential version - Time taken by function: " << duration_sequential.count() << " microseconds" << endl;
    ...
    // Output the execution time for the parallel version
    cout << "Parallel version - Time taken by function: " << duration.count() << " microseconds" << endl;
